...
-- Add a computed column for distance calculations (MySQL-specific)
-- This will help with spatial queries performance
ALTER TABLE properties ADD COLUMN IF NOT EXISTS location_point POINT GENERATED ALWAYS AS (POINT(longitude, latitude)) STORED;

-- Create spatial index on the generated point column (if supported)
-- CREATE SPATIAL INDEX idx_properties_location_point ON properties (location_point);
...
('Modern CBD Apartment', 'Luxurious 2-bedroom apartment in the heart of Melbourne CBD', 
 ...
 'APARTMENT', 'LONG_TERM', 5200, 650, 50, 85.5, 2, 2, 15, 20, '2024-02-01',
...
('Elegant South Yarra Townhouse', 'Beautiful 3-bedroom townhouse near Toorak Road', 
 ...
 'TOWNHOUSE', 'LONG_TERM', 7800, 780, 0, 145.0, 3, 2, 0, 2, '2024-02-15',
...
('Charming Carlton Terrace', 'Historic 2-bedroom terrace house near Melbourne Uni', 
 ...
 'HOUSE', 'LONG_TERM', 6240, 520, 30, 120.0, 2, 1, 0, 2, '2024-03-01',
...
('Trendy Fitzroy Loft', 'Industrial-style 1-bedroom loft in trendy Fitzroy', 
 ...
 'STUDIO', 'SHORT_TERM', 2400, 480, 20, 55.0, 1, 1, 2, 3, '2024-02-10',
...
('Richmond Warehouse Conversion', 'Spacious 2-bedroom converted warehouse', 
 ...
 'APARTMENT', 'LONG_TERM', 5200, 650, 40, 95.0, 2, 2, 1, 3, '2024-02-20',
...
('Beachside St Kilda Unit', '1-bedroom unit walking distance to St Kilda Beach', 
 ...
 'APARTMENT', 'SHORT_TERM', 3120, 520, 35, 60.0, 1, 1, 3, 4, '2024-02-25',
...
('Prahran Family Home', 'Spacious 4-bedroom family home with garden', 
 ...
 'HOUSE', 'LONG_TERM', 9360, 780, 0, 180.0, 4, 2, 0, 2, '2024-03-10',
...
('Collingwood Artist Studio', 'Creative space with living area for artists', 
 ...
 'STUDIO', 'LONG_TERM', 2880, 360, 25, 40.0, 1, 1, 1, 2, '2024-02-28',
